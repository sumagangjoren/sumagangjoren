    ...
    return (
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {projects.map((project) => (
          <div
            key={project.title}
            className="border border-white/10 bg-white/5 rounded-xl overflow-hidden transition hover:border-green-300/40 hover:bg-white/10"
          >
            ...
            <div className="p-6">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 text-sm px-4 py-2 rounded-md border border-white/20 transition hover:border-green-300 hover:text-green-300"
                >
